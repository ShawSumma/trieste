...
static inline tri_t world_gen_serpinski(tri_table_t *table, size_t n, tri_t color, tri_t object) {
    tri_t ret = object;
    tri_t base = color;
    for (int i = 0; i < n; i++) {
...
static inline tri_t world_gen_serpinski_meta(tri_table_t *table, size_t n, size_t m, tri_t color, tri_t object) {
    tri_t a = color;
    tri_t b = object;
    for (int i = 0; i < n; i++) {
        tri_t old_a = a;
...
static inline tri_t world_gen_proc_range(tri_table_t *table, void *ctx, world_gen_proc_t *proc, size_t n, tri_bounds_t bounds) {
    if (n == 0) {
...
static inline tri_t world_gen_proc(tri_table_t *table, void *ctx, world_gen_proc_t *proc, size_t n) {
