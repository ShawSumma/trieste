...
static inline vector2_t vector2_mid3(vector2_t a, vector2_t b, vector2_t c) {
    return (vector2_t) {
...
static inline vector2_t vector2_lerp(vector2_t a, vector2_t b, double n) {
    return (vector2_t) {
...
static inline double vector2_len(vector2_t a) {
    return sqrt(a.x*a.x + a.y*a.y);
}

static inline double vector2_dist(vector2_t a, vector2_t b) {
